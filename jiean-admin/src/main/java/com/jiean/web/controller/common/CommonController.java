...
import com.jiean.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            String filePath = JieAnConfig.getDownloadPath() + fileName;
    ...
    public RestResponse uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = JieAnConfig.getUploadPath();
            // 上传并返回新文件名称
            String fileName = FileUploadUtils.upload(filePath, file);
            String url = serverConfig.getUrl() + fileName;
            RestResponse restResponse = RestResponse.success();
            restResponse.put("fileName", fileName);
            restResponse.put("url", url);
            return restResponse;
        } catch (Exception e) {
    ...
    public void resourceDownload(String name, HttpServletRequest request, HttpServletResponse response) throws Exception {
        // 本地资源路径
        String localPath = JieAnConfig.getProfile();
        // 数据库资源地址

...
import com.jiean.common.core.domain.entity.SysDictType;
...
public class SysDictTypeController extends BaseController {
    ...
    @GetMapping("/export")
    public RestResponse export(SysDictType dictType) {
        List<SysDictType> list = dictTypeService.selectDictTypeList(dictType);
    ...
    public RestResponse getInfo(@PathVariable Long dictId) {
        return RestResponse.success(dictTypeService.selectDictTypeById(dictId));
    }
    ...
    @PostMapping
    public RestResponse add(@Validated @RequestBody SysDictType dict) {
        if (UserConstants.NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict))) {
            return RestResponse.error("新增字典'" + dict.getDictName() + "'失败，字典类型已存在");
        }
    ...
    @PutMapping
    public RestResponse edit(@Validated @RequestBody SysDictType dict) {
        if (UserConstants.NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict))) {
            return RestResponse.error("修改字典'" + dict.getDictName() + "'失败，字典类型已存在");
        }
    ...
    public RestResponse optionselect() {
        ...
        return RestResponse.success(dictTypes);
    }
}

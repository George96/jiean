...
public class SysRoleController extends BaseController {
    ...
    @GetMapping("/export")
    public RestResponse export(SysRole role) {
        List<SysRole> list = roleService.selectRoleList(role);
    ...
    public RestResponse getInfo(@PathVariable Long roleId) {
        return RestResponse.success(roleService.selectRoleById(roleId));
    }
    ...
    public RestResponse add(@Validated @RequestBody SysRole role) {
        if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleNameUnique(role))) {
            return RestResponse.error("新增角色'" + role.getRoleName() + "'失败，角色名称已存在");
        } else if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role))) {
            return RestResponse.error("新增角色'" + role.getRoleName() + "'失败，角色权限已存在");
        }
    ...
    @PutMapping
    public RestResponse edit(@Validated @RequestBody SysRole role) {
        //roleService.checkRoleAllowed(role);
        if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleNameUnique(role))) {
            return RestResponse.error("修改角色'" + role.getRoleName() + "'失败，角色名称已存在");
        } else if (UserConstants.NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role))) {
            return RestResponse.error("修改角色'" + role.getRoleName() + "'失败，角色权限已存在");
        }
        ...
        return RestResponse.error("修改角色'" + role.getRoleName() + "'失败，请联系管理员");
    }
    ...
    public RestResponse dataScope(@RequestBody SysRole role) {
        roleService.checkRoleAllowed(role);
    ...
    public RestResponse optionselect() {
        return RestResponse.success(roleService.selectRoleAll());
    }
}
